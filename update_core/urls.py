"""
URL configuration for update_core project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="Update Tech Limited",
        default_version='v1',
        description="Job Assessment",
        terms_of_service="https://www.domain-nai-amar.com/policies/terms/",
...
urlpatterns = [
    ...
    path('sales/api/v1/', include('sales.urls')),
